...
public class Stream10Sorted5 {
	...
	public static void main(String[] args) {
		...
		List<Integer> lis2 = marks.stream().sorted((i,j) -> i.compareTo(j)).collect(Collectors.toList());
		System.out.println(lis2);
		
		List<Integer> lis3 = marks.stream().sorted((i,j) -> -i.compareTo(j)).collect(Collectors.toList());
