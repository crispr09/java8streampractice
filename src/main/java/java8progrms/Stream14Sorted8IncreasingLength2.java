 ...
 *
 */
public class Stream14Sorted8IncreasingLength2 {
	...
	public static void main(String[] args) {
		...
		List<String> lis22 = marks.stream().sorted(c2).collect(Collectors.toList());
		System.out.println(lis22);
